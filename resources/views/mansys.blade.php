                                                            ...
                                                            <div class="mpgdetail">
                                                                <div class="meditor">
                                                                    ...
                                                                    <div class="qbi-sheet-panel">
                                                                        <div id="mansysSheetDashboard" class="qbi-sheet-dashboard">
                                                                            <div class="qbi-sheet-table-wrap" id="mansysSheetTableWrap">
                                                                                <div class="qbi-sheet-message">Loading schedule...</div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="qbi-sheet-actions">
                                                                            <div class="qbi-sheet-status" id="mansysSheetLastUpdated">
                                                                                Last Updated: loading...</div>
                                                                            <div class="qbi-sheet-controls">
                                                                                {{--
                                                                                <button type="button"
                                                                                    class="qbi-sheet-button qbi-sheet-button--secondary"
                                                                                    id="mansysSheetRefresh">Refresh</button>
                                                                                --}}
                                                                                {{--
                                                                                <a class="qbi-sheet-button qbi-sheet-button--primary"
                                                                                    href="https://docs.google.com/spreadsheets/d/1zC0lK_22adiDm2a8QklwT-JkCOgcUJwwskGXwT67rFc/edit?usp=sharing"
                                                                    ...
                                                                    <script>
                                                                        (function() {
                                                                            const MANSYS_SHEET_API_URL = 'https://script.google.com/macros/s/AKfycbxBZ7ynsw6oCbE8HE9zNbUl59DjpUrCwQT0QlRbx0m5RRsZ409BaamZ1glaqjc9zO8/exec';
                                                                            var dashboard = document.getElementById('mansysSheetDashboard');
                                                                            var tableWrap = document.getElementById('mansysSheetTableWrap');
                                                                            var refreshButton = document.getElementById('mansysSheetRefresh');
                                                                            var lastUpdated = document.getElementById('mansysSheetLastUpdated');
                                                                            ...
                                                                            function isPlaceholderUrl(source) {
                                                                                return !source || source === 'PASTE_MANSYS_APPS_SCRIPT_WEB_APP_URL_HERE';
                                                                            }
                                                                            ...
                                                                            function loadSheetData() {
                                                                                var freshApiUrl = isPlaceholderUrl(MANSYS_SHEET_API_URL) ? '' : buildFreshUrl(MANSYS_SHEET_API_URL);
                                                                                var requestSeq = ++sheetRequestSeq;

                                                                                if (isPlaceholderUrl(MANSYS_SHEET_API_URL)) {
