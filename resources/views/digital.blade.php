                                                            ...
                                                            <div class="mpgdetail">
                                                                <div class="meditor">
                                                                                    ...
                                                                                    <p>
                                                                                        <span
                                                                                            ...
                                                                                            <span class="laboratory-detail-description"
                                                                                                ...
                                                                                                Research Building, 5th Floor</span>
                                                                                        </span>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <div class="qbi-sheet-panel">
                                                                        <div id="digitalSheetDashboard" class="qbi-sheet-dashboard">
                                                                            <div class="qbi-sheet-table-wrap" id="digitalSheetTableWrap">
                                                                                <div class="qbi-sheet-message">Loading schedule...</div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="qbi-sheet-actions">
                                                                            <div class="qbi-sheet-status" id="digitalSheetLastUpdated">
                                                                                Last Updated: loading...</div>
                                                                            <div class="qbi-sheet-controls">
                                                                                {{--
                                                                                <button type="button"
                                                                                    class="qbi-sheet-button qbi-sheet-button--secondary"
                                                                                    id="digitalSheetRefresh">Refresh</button>
                                                                                --}}
                                                                                {{--
                                                                    ...
                                                                    <script>
                                                                        (function() {
                                                                            const DIGITAL_SHEET_API_URL = 'https://script.google.com/macros/s/AKfycbxxM21tXj6HLilj-SlBVV4jxs2LigmsVFvt9z7MVjinPcSiRenA6tP9bxT3X3IMiXDq/exec';
                                                                            var dashboard = document.getElementById('digitalSheetDashboard');
                                                                            var tableWrap = document.getElementById('digitalSheetTableWrap');
                                                                            var refreshButton = document.getElementById('digitalSheetRefresh');
                                                                            var lastUpdated = document.getElementById('digitalSheetLastUpdated');
                                                                            ...
                                                                            function isPlaceholderUrl(source) {
                                                                                return !source || source === 'PASTE_DIGITAL_APPS_SCRIPT_WEB_APP_URL_HERE';
                                                                            }
                                                                            ...
                                                                            function loadSheetData() {
                                                                                var freshApiUrl = isPlaceholderUrl(DIGITAL_SHEET_API_URL) ? '' : buildFreshUrl(DIGITAL_SHEET_API_URL);
                                                                                var requestSeq = ++sheetRequestSeq;

                                                                                if (isPlaceholderUrl(DIGITAL_SHEET_API_URL)) {
