                                                                ...
                                                                <div class="meditor">
                                                                    ...
                                                                    <div class="qbi-sheet-panel">
                                                                        <iframe id="sheetFrame" class="qbi-sheet-frame"
                                                                            src="about:blank"
                                                                            data-sheet-src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQEma0FIE1t_dlSvpeAMlN21bSINM-b4l4B-ws-prxMJX_Ph0DqvQGd-fhuK93Vkum6WXf8PYIuNczq/pubhtml?gid=664288191&amp;single=true&amp;range=A1:H19"
                                                                            data-timestamp-src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQEma0FIE1t_dlSvpeAMlN21bSINM-b4l4B-ws-prxMJX_Ph0DqvQGd-fhuK93Vkum6WXf8PYIuNczq/pub?gid=664288191&amp;single=true&amp;output=csv&amp;range=Z1"></iframe>
                                                                        <div class="qbi-sheet-actions">
                                                                            ...
                                                                            <div class="qbi-sheet-controls">
                                                                                ...
                                                                                <a class="qbi-sheet-button qbi-sheet-button--primary"
                                                                                    href="https://docs.google.com/spreadsheets/d/1D6VbBIEZ-4pGlaNqg40Vk3rQcRY5R2RHS-hfJbRfZvA/edit?usp=sharing"
                                                                    ...
                                                                    <script>
                                                                        (function() {
                                                                            ...
                                                                            function loadSheetFrame() {
                                                                                var source = sheetFrame.getAttribute('data-sheet-src');

                                                                                if (!source) {
                                                                                    return;
                                                                                }

                                                                                sheetFrame.src = buildFreshUrl(source, 'cacheBust');
                                                                            }

                                                                            function loadLastUpdated() {
                                                                                var source = sheetFrame.getAttribute('data-timestamp-src');

                                                                                if (!lastUpdated || !source || !window.fetch) {
                                                                                    if (lastUpdated) {
                                                                                ...
                                                                                fetch(buildFreshUrl(source, 'cacheBust'))
