                                                            ...
                                                            <div class="mpgdetail">
                                                                <div class="meditor">
                                                                    ...
                                                                    <div class="qbi-sheet-panel">
                                                                        <div id="qbiSheetDashboard" class="qbi-sheet-dashboard">
                                                                            <div class="qbi-sheet-table-wrap" id="qbiSheetTableWrap">
                                                                    ...
                                                                    <script>
                                                                        (function() {
                                                                            const QBI_SHEET_API_URL = 'https://script.google.com/macros/s/AKfycbx-0-O8PBhxNwIgEYJuJ5UX3vGmK1C1EbT9gIG7RDJMiXzbYK_YGBCBAM0dm9n5bw7LMA/exec';
                                                                            var dashboard = document.getElementById('qbiSheetDashboard');
                                                                            var tableWrap = document.getElementById('qbiSheetTableWrap');
                                                                            ...
                                                                            function isPlaceholderUrl(source) {
                                                                                return !source || source === 'PASTE_QBI_APPS_SCRIPT_WEB_APP_URL_HERE';
                                                                            }
                                                                            ...
                                                                            function loadSheetData() {
                                                                                var freshApiUrl = isPlaceholderUrl(QBI_SHEET_API_URL) ? '' : buildFreshUrl(QBI_SHEET_API_URL);
                                                                                var requestSeq = ++sheetRequestSeq;

                                                                                if (isPlaceholderUrl(QBI_SHEET_API_URL)) {
