...
<head>
    ...
    <title>Engineering Management Laboratory</title>
                                                            ...
                                                            <div class="mpgdetail">
                                                                <div class="meditor">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="1" rowspan="3"
                                                                                    ...
                                                                                    <img alt="Engineering Management Laboratory"
                                                                                ...
                                                                                <td colspan="1" rowspan="3"
                                                                                    ...
                                                                                    <p>
                                                                                        <span
                                                                                            ...
                                                                                            <span
                                                                                                style="font-size:0.875em;"><strong>Engineering
                                                                                                    Management
                                                                                                    (EM) - C 3.01</strong></span><br />
                                                                                            <span class="laboratory-detail-description"
                                                                                                style="font-size:0.75em;">The
                                                                                                EM Laboratory focuses on
                                                                                                ...
                                                                                                Research Building, 3rd Floor</span>
                                                                                        </span>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <div class="qbi-sheet-panel">
                                                                        <div id="emSheetDashboard" class="qbi-sheet-dashboard">
                                                                            <div class="qbi-sheet-table-wrap" id="emSheetTableWrap">
                                                                                <div class="qbi-sheet-message">Loading schedule...</div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="qbi-sheet-actions">
                                                                            <div class="qbi-sheet-status" id="emSheetLastUpdated">
                                                                                Last Updated: loading...</div>
                                                                            <div class="qbi-sheet-controls">
                                                                                {{--
                                                                                <button type="button"
                                                                                    class="qbi-sheet-button qbi-sheet-button--secondary"
                                                                                    id="emSheetRefresh">Refresh</button>
                                                                                --}}
                                                                                {{--
                                                                                <a class="qbi-sheet-button qbi-sheet-button--primary"
                                                                                    href="https://docs.google.com/spreadsheets/d/1-v-FlyPiP9Vn70H5HaAzOUjmRpJTZV94qjM4A_POTw8/edit?usp=sharing"
                                                                    ...
                                                                    <script>
                                                                        (function() {
                                                                            const EM_SHEET_API_URL = 'https://script.google.com/macros/s/AKfycbwkFiBw5FnwdO3SXfEsQGb878xVsZQn_pOsp3l8i1InRgqiFlqHyB1YV8_Otvf0D01bBw/exec';
                                                                            var dashboard = document.getElementById('emSheetDashboard');
                                                                            var tableWrap = document.getElementById('emSheetTableWrap');
                                                                            var refreshButton = document.getElementById('emSheetRefresh');
                                                                            var lastUpdated = document.getElementById('emSheetLastUpdated');
                                                                            ...
                                                                            function isPlaceholderUrl(source) {
                                                                                return !source || source === 'PASTE_EM_APPS_SCRIPT_WEB_APP_URL_HERE';
                                                                            }
                                                                            ...
                                                                            function loadSheetData() {
                                                                                var freshApiUrl = isPlaceholderUrl(EM_SHEET_API_URL) ? '' : buildFreshUrl(EM_SHEET_API_URL);
                                                                                var requestSeq = ++sheetRequestSeq;

                                                                                if (isPlaceholderUrl(EM_SHEET_API_URL)) {
