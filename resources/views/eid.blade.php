                                                            ...
                                                            <div class="mpgdetail">
                                                                <div class="meditor">
                                                                                    ...
                                                                                    <p>
                                                                                        <span
                                                                                            ...
                                                                                            <span class="laboratory-detail-description"
                                                                                                ...
                                                                                                Research Building, 1st Floor</span>
                                                                                        </span>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <div class="qbi-sheet-panel">
                                                                        <div id="eidSheetDashboard" class="qbi-sheet-dashboard">
                                                                            <div class="qbi-sheet-table-wrap" id="eidSheetTableWrap">
                                                                                <div class="qbi-sheet-message">Loading schedule...</div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="qbi-sheet-actions">
                                                                            <div class="qbi-sheet-status" id="eidSheetLastUpdated">
                                                                                Last Updated: loading...</div>
                                                                            <div class="qbi-sheet-controls">
                                                                                {{--
                                                                                <button type="button"
                                                                                    class="qbi-sheet-button qbi-sheet-button--secondary"
                                                                                    id="eidSheetRefresh">Refresh</button>
                                                                                --}}
                                                                                {{--
                                                                                <a class="qbi-sheet-button qbi-sheet-button--primary"
                                                                                    href="https://docs.google.com/spreadsheets/d/1Ya4M2vc0Vvs0O-oLNcYczwBbolZrxRBpEqaHuB3kNnk/edit?usp=sharing"
                                                                    ...
                                                                    <script>
                                                                        (function() {
                                                                            const EID_SHEET_API_URL = 'https://script.google.com/macros/s/AKfycbxSq6RSrP2kMRQQgb_YezzzQ5KErH6G0KawPeJHgpk30OUwckRkQp1gkzrSWlYIV5Z3/exec';
                                                                            var dashboard = document.getElementById('eidSheetDashboard');
                                                                            var tableWrap = document.getElementById('eidSheetTableWrap');
                                                                            var refreshButton = document.getElementById('eidSheetRefresh');
                                                                            var lastUpdated = document.getElementById('eidSheetLastUpdated');
                                                                            ...
                                                                            function isPlaceholderUrl(source) {
                                                                                return !source || source === 'PASTE_EID_APPS_SCRIPT_WEB_APP_URL_HERE';
                                                                            }
                                                                            ...
                                                                            function loadSheetData() {
                                                                                var freshApiUrl = isPlaceholderUrl(EID_SHEET_API_URL) ? '' : buildFreshUrl(EID_SHEET_API_URL);
                                                                                var requestSeq = ++sheetRequestSeq;

                                                                                if (isPlaceholderUrl(EID_SHEET_API_URL)) {
