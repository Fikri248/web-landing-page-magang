...
<head>
    ...
    <title>Enterprise System Laboratory</title>
                                                                ...
                                                                <div class="mpgdetail">
                                                                    <div class="meditor">
                                                                                    ...
                                                                                    <td colspan="1" rowspan="3"
                                                                                        ...
                                                                                        <p>
                                                                                            <span
                                                                                                ...
                                                                                                <span
                                                                                                    style="font-size:0.875em;"><strong>Enterprise
                                                                                                        System
                                                                                                        (SE) - C 3.07</strong></span><br />
                                                                        ...
                                                                        <div class="qbi-sheet-panel">
                                                                            <div id="seSheetDashboard" class="qbi-sheet-dashboard">
                                                                                <div class="qbi-sheet-table-wrap" id="seSheetTableWrap">
                                                                                    <div class="qbi-sheet-message">Loading schedule...</div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="qbi-sheet-actions">
                                                                                <div class="qbi-sheet-status" id="seSheetLastUpdated">
                                                                                    Last Updated: loading...</div>
                                                                                <div class="qbi-sheet-controls">
                                                                                    {{--
                                                                                    <button type="button"
                                                                                        class="qbi-sheet-button qbi-sheet-button--secondary"
                                                                                        id="seSheetRefresh">Refresh</button>
                                                                                    --}}
                                                                                    {{--
                                                                        ...
                                                                        <script>
                                                                            (function() {
                                                                                const SE_SHEET_API_URL = 'https://script.google.com/macros/s/AKfycbzaeyh2KWSHFvonW5qvSJ4YYEHoDFk7yASe3UIRboVvBhUdEf1z5z8TZUvCtf9dNwGHGQ/exec';
                                                                                var dashboard = document.getElementById('seSheetDashboard');
                                                                                var tableWrap = document.getElementById('seSheetTableWrap');
                                                                                var refreshButton = document.getElementById('seSheetRefresh');
                                                                                var lastUpdated = document.getElementById('seSheetLastUpdated');
                                                                                ...
                                                                                function isPlaceholderUrl(source) {
                                                                                    return !source || source === 'PASTE_SE_APPS_SCRIPT_WEB_APP_URL_HERE';
                                                                                }
                                                                                ...
                                                                                function loadSheetData() {
                                                                                    var freshApiUrl = isPlaceholderUrl(SE_SHEET_API_URL) ? '' : buildFreshUrl(SE_SHEET_API_URL);
                                                                                    var requestSeq = ++sheetRequestSeq;

                                                                                    if (isPlaceholderUrl(SE_SHEET_API_URL)) {
